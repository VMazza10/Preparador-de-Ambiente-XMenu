            ...
            try {
                ...
                if ($null -eq $svc) {
                    ...
                    [System.Windows.Forms.MessageBox]::Show(
                        ...
                        "O recurso LPD foi instalado, mas o servico ainda nao existe nesta maquina.`n`nIsso e normal: o Windows so cria o LPDSVC depois de REINICIAR.`n`n>>> Reinicie o computador e clique neste botao de novo. <<<",
                ...
                elseif ($svc.Status -ne 'Running' -or -not $escutando) {
                    ...
                    [System.Windows.Forms.MessageBox]::Show(
                        $Script:PrinterManagerForm,
                        "A configuracao rodou, mas o LPD NAO ficou ativo:`n`n   Servico LPDSVC : $($svc.Status)`n   Porta 515      : $(if ($escutando) { 'escutando' } else { 'NAO esta escutando' })`n`nNa maioria das vezes resolve REINICIAR o computador e clicar neste botao de novo.`n`nSe continuar assim, verifique se algum antivirus esta bloqueando o servico.",
...
$bSrv.Text = "Servicos do SQL Server e do Sistema"; $bSrv.Font = New-Object System.Drawing.Font("Segoe UI", 10, [System.Drawing.FontStyle]::Bold)
$bSrv.Cursor = 'Hand'
Format-SupportBtn $bSrv $colorDiag
$Script:ToolTip.SetToolTip($bSrv, "Mostra o estado do SQL Server, SQL Browser, Spooler e servicos do sistema. Permite iniciar, parar, reiniciar, deixar em inicio automatico e testar a porta 1433 do servidor.")

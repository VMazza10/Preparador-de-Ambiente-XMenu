...
$form.Text = "Preparador XMenu – Suporte Técnico v5.2 - REVENDA"
...
Log-Message "INFO" "Preparador XMenu v5.2 - REVENDA - preparo e suporte de computadores com XMenu e NetPDV"
Log-Message "LOG" "==============================================================="

...
$form.Text = "Preparador XMenu – Suporte Técnico v5.12 - REVENDA"
...
Log-Message "INFO" "Preparador XMenu v5.12 - REVENDA - preparo e suporte de computadores com XMenu e NetPDV"
Log-Message "LOG" "==============================================================="

...
$form.Text = "Preparador XMenu – Suporte Técnico v5.13 - REVENDA"
...
Log-Message "INFO" "Preparador XMenu v5.13 - REVENDA - preparo e suporte de computadores com XMenu e NetPDV"
Log-Message "LOG" "==============================================================="

...
$form.Text = "Preparador XMenu – Suporte Técnico v5.27"
...
Log-Message "INFO" "Preparador XMenu v5.27 - preparo e suporte de computadores com XMenu e NetPDV"
Log-Message "LOG" "==============================================================="

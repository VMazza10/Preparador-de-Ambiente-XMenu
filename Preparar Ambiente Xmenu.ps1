...
$form.Text = "Preparador XMenu – Suporte Técnico v5.25"
...
Log-Message "INFO" "Preparador XMenu v5.25 - preparo e suporte de computadores com XMenu e NetPDV"
Log-Message "LOG" "==============================================================="

...
$form.Text = "Preparador XMenu – Suporte Técnico v5.8"
...
Log-Message "INFO" "Preparador XMenu v5.8 - preparo e suporte de computadores com XMenu e NetPDV"
Log-Message "LOG" "==============================================================="

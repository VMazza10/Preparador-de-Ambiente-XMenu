...
$form.Text = "Preparador XMenu – Suporte Técnico v5.32"
...
Log-Message "INFO" "Preparador XMenu v5.32 - preparo e suporte de computadores com XMenu e NetPDV"
Log-Message "LOG" "==============================================================="
